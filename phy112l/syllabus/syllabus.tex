...
\begin{tabbing}
\hspace*{8em} \= \kill 
\textbf{Textbooks:} \> Thermal Physics by Daniel V. Schroeder\\
...
Applications of computational physics to problems from Statistical Mechanics.  Application of numerical techniques, and comparison to analytic
solutions (where they exist).\\[8pt]

...
\begin{tabbing}
\hspace*{8em} \= \kill 
\textbf {Lecture:} \> M,W,F 9:00-9:50 AM in Lecture Teaching and Learning Complex 3210 \\
\> (next to Silo, to the west) 
\end{tabbing}
\noindent
\begin{tabbing}
\hspace*{8em} \= \kill 
...
\hspace*{8em}\= \hspace*{10em} \= \kill 
\textbf{Office Hours:}
    \> Mulhearn: \> Monday 10:30-11:45 AM PHY 317\\
    \> Cai:   \> Tuesdays: 11:00 AM-12:00 PM  (PHY 416)\\
    \> Huang: \> Tuesdays:  2:00-3:00 PM   (PHY 416)\\
\end{tabbing}
\noindent
\begin{tabbing}
\hspace*{12em}\= \kill 
...
\hline
2  & Jan 13,15,17    & Special Relativity       &               \\
\hline
3  & Jan 22,24       & Relativistic Kinematics  &  G 3.1-3.5    \\      
\hline               
4  & Jan 27,29,31    & Decay Rates and Cross Sections  & G: 6.1-6.2 \\  
   &                 &                                 & (TH: 3.1-3.5) \\
   &                 & Feynman Calculus                & G: 6.3 \\      
\hline                                                                  
...
\hline
7  & Feb 19,21       & Quantum Electrodynamics          & G: 7.4-7.9 \\     
\hline                                                                  
8  & Feb 24,26,28    & Quantum Chromodynamics          & TBD   \\
\hline                                                                  
9  & Mar 3,5,7       & Quantum Chromodynamics          & TBD \\
\hline                                                                  
10 & Mar 10,12,14    & TBD & \\                                         
\hline                                                                  
\end{tabular}\\

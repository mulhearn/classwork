...
and so:
$$0 = \braket{\left(\hat{Q}-q\right)^2} = \braket{\left(\Psi|(\hat{Q}-q\right)^2\Psi}$$
but since $Q$ is an observable and $q$ is a real number $Q-q$ is a hermitian operator so:
...
The collection of all the eigenvalues is called the spectrum of an operator.

\section{Eigenfunctions of Operators with Discrete Spectra}



Degeneracy and Linear Independence.

\section{More on the delta function...}

\section{Eigenfunctions of Operators with Continuous Spectra}

...
division coursework outside of the Physics 
and Astronomy Department.  This proposals
...
\item The GeoPhysics major requires the courses listed in
Table~\ref{tbl:geophysics}.  An
example schedule is presented in Table~\ref{tbl:geophysics-two-year}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% \section{Proposed Geological Physics Major}
%% \label{sec:geo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\captionof{table}{\label{tbl:geophysics} Geophysics}
\vskip 0.25cm
\noindent
{\bf Additional Preparatory Courses:  }\\
...
\hline
     & incl at least two:  & & & & \\
\hline
     & 161    & 3 & S$^\#$ & GEL 50 & Geophysical Field Methods \\
...
\newpage
\noindent
\captionof{table}{\label{tbl:geophysics-two-year} Geophysics}
\noindent
Example two year schedule: In most cases, the PHY 9D and GEL 50 are taken
before the junior year, but an example including these courses is
shown.  Physics course numbers are shown unless otherwise indicated.
Courses in italics are electives.
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.10in
\centerline{\large \bf A1:   Course Content Changes}
\vskip0.10in
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.20in
\centerline{\large \bf A2:   Theoretical Physics}
\vskip0.10in
...
The Physics and Astronomy Department has recently adopted a procedure for
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.20in
\centerline{\large \bf A3:   Computational Physics}
\vskip0.10in
...
%% Section~\ref{sec:labs}, 
Appendix A3.
but it is included in this discussion as it
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.20in
\centerline{\large \bf A4:   Experimental Physics}
\vskip0.10in
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.20in
\centerline{\large \bf A5:   Prerequisites}
\vskip0.10in
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\centerline{\Large \bf Appendix B:   Example Course Syllabi}
\vskip0.10in
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vskip0.10in
\centerline{\Large \bf Appendix C:  Implementation}
\vskip0.10in

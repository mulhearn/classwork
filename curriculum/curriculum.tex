...
G$\to$EPS & 60$\to$101          & 4$\to$3 & CHE 4B(C-), G$\to$EPS 50+L & Earth Materials\\
\hline
\end{tabular}\\
...
G$\to$EPS & 101$\to$102\# & 3 & GEL/EPS 50L & Structural Geology \\
          & 162\#         & 3 & GEL/EPS 50    & Geophysics of the Solid Earth \\
...
\newpage
\captionof{table}{\label{tbl:atmospheric}Atmospheric Physics (EPS version)}
\vskip 0.25cm
\noindent
{\bf Additional Preparatory Courses:  }\\

...
\title{Proposal for Revising the \\ Undergraduate Physics Curriculum \\ Version 1.15}
...
\begin{itemize}
 ...
 \item The requirements for the physical oceanography major have been
   udpated to add additional choices for upper division course work. 
...
\newpage
\vskip 2cm
\captionof{table}{ Math prerequisite for lower division courses related to this proposal.  Where indicated, course grades are the minimum accepted to meet prerequisite.  The prerequisites for the math courses are set by the math department and are only reported here.}
...
courses 9HE, 102, 104B, 110C and replacing 116ABC with 117 and 118
frees 4.3 instructors, for a net decrease of 1.3 instructors.  If the
need for more sections of 80 requires an additional
instructor (currently typically two, although three were initially
planned for 2020-2021) there would be a decrease of 0.3 instructors.
Additional fall offerings for 122A/B could be added as well, if needed
to meet demand.
...
\item 110L, 112L, and 115L: These three new one-unit computational lab
  ...
  BS physics majors are required to take all three.  A major emphasis
  of these lab courses is to give students practice at using
  programing to solve computational physics problems {\em
    independently}.
...
\item PHY 80 (which replaces 80) adds 40 as a prerequisite.
\item PHY 122A/B adds a 115A prerequisite, which was implicit when
  ...
  be concurrent, which will not be possible unless we add a fall
  offering of 122A/B.
...
\vskip 0.25cm
\begin{center}
Units:  48-50. *: recommended, $\parallel$: concurrently.\\
\begin{tabular}{|lll|}
\hline
Course & & Units \\
\hline
...
computing labs (from 110L,112L, and 115L).  Most require two upper
...
be adjusted to match the plan: PHY 116A will cover the PHY 116
...
have taken PHY 116, but for the vast majority, it will have been taught
...
\captionof{table}{ Junior year during transition, Transfer Students}

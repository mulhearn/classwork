...
is several years in the future and hence not currently in ICMS.)

PHY 116ABC will evolve into PHY 117,118.  None of these will affect
majors outside of physics, nor will they necessitate any additional
instructors.  See Appendix A1 for a complete list of course content
changes.

In 2024 and 2025, the proposal was updated to adjust to changing
prerequisites, which pushed some majors over unit caps (once implicit
prerequisites were added).  In the proposal, there are no implicit
prerequisites: if a coruse is needed for a required course, it is
included as a required course.  The unit tallies for all majors has
been checked several times, and clarifying remarks have been added.
The availability and pre-requisites of all courses for non-majors was
confirmed.
...
ECS & 20            & 4 & MAT 21A(C-)  & Discrete Math for CS\\
    & 32A$\dagger$  & 4 &              & Intro to Programming (Python)\\
\hline
\hline
 & & & Either: & \\
ECS & 32B  & 4 & ECS 32A/36A(C-)  & Intro to Data Structures (Python)\\
    & 32C  & 4 & ECS 32B(C-)      & Impl of Data Structures (Unix/C)\\
    & 34*  & 4 & ECS 34C(C-)      & Software Dev. in Unix \& C++ \\
\hline
    & & & or: & \\
ECS & 36A  & 4 & ECS 32A/32AV(C-)    & Programming and Problem Solving\\
    & 36B  & 4 & ECS 36A(C-)         & Software Dev. and OOP in C++\\
    & 36C  & 4 & ECS 20(C-), 36B(C-) & Data Structs, Algs, and Programming\\
\hline
\end{tabular}\\
*: recommended \\
$\dagger$: ECS 32AV  can replace ECS 32A when the latter is unavailable.
\vskip 0.25cm
\noindent

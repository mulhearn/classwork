...
all feedback from the faculty, including specific faculty assigned to
read each section.  At this point, every section of the proposal has
been scrutinized by at least one faculty member that was not involved
in producing the draft.  The changes since the last version are:
\begin{itemize}
 ...
 \item The prerequisites for Physics 9 and 9H have been updated.  For
   better readability, the math prerequisites for lower division coursework is
   now broken out into a separate table.
 \item The requirements for the chemical physics major have been
   updated.   
 \item In the previous version, 116ABC was replaced by 80,116A, and
   116B.  The course numbering has been changed in this version to
   80,116,and 117. This change is intended to clearly indicate that
   116 and 117 are now independent courses.
 \item Various small changes to the text were made to improve clarity
   and accuracy, and to fix grammar mistakes and typos.
 \item The alternative AB physics requirements (in case the proposed 81 unit version is not accepted) have been updated.
\end{itemize}
...
\vskip 0.25cm
\noindent
Units:  53-54. *: recommended, $\parallel$ concurrently, when indicated grades are minimum accepted.\\
...
\captionof{table}{\label{tbl:depth-applied}
  Depth Subject Matter:  All Applied Physics Majors}
\noindent
\vskip 0.25cm
\begin{center}
\begin{tabular}{|lll|}
...
Junior    & 104A      & 110A           & 110B+L \\
          & EEC 100   & {\it EEC 110A} & {\it EEC 110B}\\

...
PHY & 9A & 5 & FWS &         & Class. Physics {\it (Class. Mech.)}\\
    & 9B & 5 & FWS & 9A/9HA  & Class. Physics {\it (Waves, Thermo, Optics)}\\
    & 9C & 5 & FWS & 9B      & Class. Physics {\it (Elec. and Magn.)}\\ 
...
PHY & 9A & 21B/21BH/21M/17C(C-) or 17B(B) & Class. Physics\\
    ...
    & 9D & 22A/27A/67(C-) $\parallel$22B & Class. Physics\\
\hline
\hline
...
\newpage
\section{New Section...for ASTRO+Applied Prep}
...
\vskip 0.25cm
\begin{center}
  Units (minimum): 48. *: recommended.\\
  $\dagger$: Computational physics majors may substitute ECS 32A for PHY 40\\
  (we still recommend they take PHY 40 as well)\\
\begin{tabular}{|lll|}
\hline
Course & & Units \\
\hline

...
\item The Computational Physics major does not require PHY 45 and ECS
  36B or 32C will satisfy the prerequisite for the computing labs.  The
...
\item Geological Physics (Table~\ref{tbl:geophysics})
...
\item The Physical and Chemical Oceanography course (GEL 150A) is not
  ...
  We presume CHE 4C is adequate for CHE 2C prerequisites despite not
  being listed in the course catalog.

\item The Chemical Physics major requires the courses listed in
  Tables~\ref{tbl:prep} and~\ref{tbl:chemical}.  An example schedule
  is presented in Table~\ref{tbl:chemical-two-year}.  Both chemistry
...
listed as an alternative prerequisite for CHE 110B.  Or if PHY 40
could replace ECS 32A as prerequisite for ECS 32B.
...
PHY & 122A/B & 4 & & \\
    ...
    & 118    & 4 & & \\
    & & & at most one of: & \\
EMS & 162L   & 3 &  & Structure \& Characterization Lab\\
    & 170L   & 3 &  & Sustainable Energy Lab \\
    & 172L   & 3 &  & Smart Materials Lab \\
    & 174L   & 3 &  & Mech. Behavior of Materials Lab \\
\hline
\end{tabular}\\
\noindent
...
GEL & 116N     & 3 & GEL 50    & Oceanography\\
    & 140      & 4 & GEL 50    & Intro. to Process Geomorphology\\
    & 146      & 4 & CHE 2C/4C & Radiogenic Isotope Geochemistry \\
...
{\bf Total Units (minimum):} 110
(Tables \ref{tbl:prep}, \ref{tbl:depth-applied}, and \ref{tbl:geophysics} $\implies 52+24+9+25$)\\
...
\noindent
$^\#$: not offered every year, $\parallel$: concurrently.\\
{\bf Total Units (minimum):} 110 (Tables \ref{tbl:prep}, \ref{tbl:depth-applied}, and \ref{tbl:atmospheric} $\implies 52+24+7+27$) \\
...
\hline
GEL & 116N     & 3 & GEL 50      & Oceanography\\
    & 150A$\#$ & 4 & GEL 116N,   & Phys. \& Chem. Oceanography\\
    &          &   & CHE 2C/4C   & \\
\hline
    & & & Choose two of & \\
\hline
...
\end{tabular}\\
\noindent
$^\#$: not offered every year, $\parallel$: concurrently, $\dagger$: at least two recommended.\\
{\bf Total Units (minimum):} 110
...
\newpage
\section{Example Schedules}

\noindent
{\bf Example schedule:}
\begin{table}[htbp]
\caption{\label{tbl:sched-computational} Example two-year schedule
for a Computational Physics major.  Students may complete PHY 9D and
all of their lower division ECS coursework at the community college,
but this example shows the case that no such coursework was completed.
...
Year      & Fall    & Winter & Spring \\
\hline
Junior    & (ECS 32A) & (ECS 32B) & (ECS 32C) \\
          & 40        & 105A      & 80   \\
          & 104A      & 110A      & 110B \\
          &           & (ECS 20)  & (9D) \\         
\hline
...
\begin{table}[htbp]
\caption{\label{tbl:sched-electronics} Example two-year schedule
for a Physical Electronics major.  Students may complete PHY 9D and
all of their lower division ENG coursework at the community college,
but this example shows the case that no such coursework was completed.
A particular feature of this major is the ability to take graduate
...
\begin{table}[htbp]
\caption{\label{tbl:sched-materials}{\bf Example schedule:} In most cases, the PHY 9D and ENG 45 requirement is satisfied before the junior year, but an example including these courses is shown.  Physics course numbers are shown unless otherwise indicated. Courses in italics are electives.}
\begin{center}
\begin{tabular}{|l|l|l|l|}
\hline
Year      & Fall    & Winter & Spring \\

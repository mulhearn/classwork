...
unamimously supported by the department in a December 2021 vote.  All
...
into PHY 117 and 118 with PHY 80 as a prequisite.  None of these
...
\item The computational courses are described in
  ...
  Computational Physics majors substitude ECS coursework for PHY 45,
...
Python tool kit establishied in PHY 40.
...
7 series also take the course.  The prequisites are one year of
...
chemical physics majors are allowed to substitude quantum mechanics
...
\item The Geological Physics major has been reworked to account for
  ...
  both of which open up opportunties for upper division electives, and
...
\item The Physical and Chemical Oceanography course (GEL 150A) now has
  ...
  required courses.  The elective choices have been udated.  See
  Table~\ref{tbl:oceanography}.  We presume (the more rigourous) CHE
...
substituded, with consent of department, in case none of these courses
are available.\\[4pt]
\noindent
...
{\bf Elective: } If PHY 122A/B lab option is choosen, one additional upper division course of 3 or more units, from PHY or ATM.
{\bf Total Units (minimum):} 110\\
...
Under these circumstances, we believe we can agressively roll out the
new requirements.  

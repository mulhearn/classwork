...
Course & & Units & Offered & Prereqs & Name \\
\hline
PHY & 104A & 4 & FS & 9C/9HD(C-),$\parallel$40   & Mathematical Physics \\
    &      &   &    & MAT 21D(C-),22A/27A/67(C-), & \\
    &      &   &    & MAT 22B/27B(C-) & \\
    & 105A & 4 & W  & 9A/9HA(C-),9C/9HD(C-), & Classical Mechanics I\\
    &      &   &    & MAT 22A/27A/67(C-), & \\
    &      &   &    & MAT $\parallel$22B/$\parallel$27B & \\
    ...
    & 110L & 1 & S  & 40(C-), 45/ECS 36B/32C(C-) & Comp. Lab in Elec. and Magn. \\
    &      &   &    & 110A, $\parallel$110B    & \\
    & 112  & 4 & F  & 9B/9HB(C-),9D/9HC(C-)      & Thermo. and Stat. Mech.\\
    &      &   &    & 104A(C-), $\parallel$115A  & \\ 
    & 112L & 1 & F  & 40(C-), 45/ECS 36B/32C(C-) & Comp. Lab in Stat. Mech. \\
    &      &   &    & $\parallel$112/$\parallel$CHE 110C &  \\
    & 115A & 4 & F  & 9C/9HD(C-),9D/9HC(C-),    & Quantum Mechanics I \\
    &      &   &    & 104A(C-), 105A(C-)        & \\
    & 115B & 4 & W  & 104A(C-), 115A(C-)        & Quantum Mechanics II \\
    & 115L & 1 & W  & 40(C-), 45/ECS 36B/32C(C-),    & Comp. Lab in Quantum Mech. \\
    &      &   &    & 115A/CHE 110A, $\parallel$115B* & \\
\hline
\hline
    & & & & Either & \\
...
\hline
    & & & & or & \\
PHY & 122A/B$\dagger$ & 4 & WS & 80(C-), 110B(C-)         & Advanced Physics Lab \\  
    &        &   &    & $\parallel$112, 115A(C-) &  \\  
\hline
\end{tabular}\\ 
\noindent
*: recommended, $\parallel$: concurrently, $\dagger$: either 122A or 122B.\\[5pt]
\noindent
...
from capstone courses (Table~\ref{tbl:capstones}), adding 4-5 courses, totaling 18-20 units with
current offerings.  Includes at most one from PHY 194H series, 195, 198, or 199.\\[5pt]
\noindent
{\bf Total Units (minimum): 109} (Table \ref{tbl:prep}, Table \ref{tbl:depth}, and electives $\implies 52+39+18$)
...
\hline
PHY & 129A  & 4 & S & 115A(C-) & Intro to Nuclear Physics \\
    & 130A  & 4 & W & 104A(C-), 115A(C-), 115B$\parallel$ & Elementary Particle Physics \\
    & 130B  & 4 & S & 104A(C-), 115A(C-), 115B(C-) & Elementary Particle Physics \\
\hline
& & & & Condensed Matter: & \\
\hline
PHY & 140A  & 4 & W & 104A(C-), 115A(C-) & Intro to Solid State Physics \\
    & 140B  & 4 & S & 110A(C-), 112(C-), 115A(C-), & Intro to Solid State Physics\\
    &       &   &   & 140A(C-), 110B$\parallel$    & \\
\hline
...
\hline
\end{tabular}\\
Only the most typical prerequisite options are listed in some cases.
$^\#$: not offered every year, $\parallel$: concurrently.\\
...
Sophomore & 9HD(5)       & 105A(4)      & 105B(4) \\
          ...
          & 40(3)        & 45(4)       & {\it 80(4)}  \\
\hline
Junior    & 115A(4) & 115B+L(5)  & {\it X(3-4)}\\
...
\hline
Senior   & 115A(4)    & 115B+L(5)     & {\it X(3-4)} \\
...
presented in Table~\ref{tbl:prep} (excluding PHY 45) and Table
\ref{tbl:depth-astro}.  To avoid version conflicts, some information
in Table \ref{tbl:depth} is not duplicated here.  Example schedules
are presented in Table~\ref{tbl:proposed-astro}.
...
PHY & 104A & 4 & & & \\ 
    & 105A & 4 & & & \\
    & 108  & 3 & S & 104A(C-), 110A(C-), 110B$\parallel$ & Optics \\
...
G$\to$EPS & 163  & 4 &  & AST 25, PHY 9ABC$\dagger$ & Planetary Geology and Geophysics\\ 
\hline
& & & & at most one of & \\ 
\hline
...
\end{tabular}\\
\noindent
The symbol G$\to$EPS notes the planned name change for GEL to EPS.  PHY 150 must be an astro topic and requires prior department approval.  PHY 198 and 199 are assumed to be taken for 4 units in the unit tally.\\
$\dagger$: we have requested that EPS explicitly include the 9H series as alternative prerequisites.  *: recommended, $^\#$: not offered every year, $\parallel$: concurrently.\\
\noindent
\noindent
...
Senior   & 115A     & 115B & 108+L\\
         & 152$^\#$ & 156$^\#$ & 157/122A/B \\
         & 112   & {\it 130A/155} & {\it 158$^\#$/129A/130B} \\
\hline 
\end{tabular}
...
Senior   & 115A     & 115B & 108+L\\
         & 151$^\#$ & 153$^\#$ & 157/122A/B \\
         & 112   & {\it 130A/155} & {\it 154$^\#$/129A/130B} \\
\hline 
\end{tabular}
\vskip 0.5cm
\end{center}
...
The applied physics majors require significant upper division
coursework outside of the physics department.  This proposals makes
several adjustments to the applied physics major requirements which
remove required courses that are no longer offered regularly, or
...
flexibility.  Many courses offer a range of prerequisites appropriate
for all of the students taking these courses, but only the most
relevant prerequisites for our majors are considered below.

The Department of Earth and Planetary Sciencies is currently updating
its course offerings, with many changing the subject from GEL to EPS.
In what follows, we use the symbol G$\to$EPS to mark this transition,
with any changing quantities that follow (e.g. course number) marked
by the $\to$ symbol as well.  We will maintain our requirements in the
catalog to track EPS as needed throughout their transition.
...
coursework in computer science engineering (ECS).  For depth
coursework, each applied physics major starts with a list of
...
not follow Table~\ref{tbl:depth-applied}.

This proposal includes modifications to all of the applied physics majors:
\begin{itemize}
...
\item The Geological Physics major has been reworked to account for
  new prerequisites and infrequent offerings of courses like G$\to$EPS
  ...
  features 12-16 units of coursework in ATM, EPS, GEL, and PHY.  See
  Table~\ref{tbl:geophysics}.
    
\item In the past, the Atmospheric Physics major required the Physical
  and Chemical Oceanography course (G$\to$EPS 150A), which now has extensive
  ...
  the more easily obtained (G$\to$EPS 116N).  The list of Atmospheric
  Physics electives has been extended.  See
  Table~\ref{tbl:atmospheric}.

\item The Physical and Chemical Oceanography course (G$\to$EPS 150A) now has
...
\hline
ECS & 20            & 4 & MAT 21A  & Discrete Math for CS\\
\hline
\hline
 & & & Either: & \\
ECS & 32A$\dagger$ & 4 &          & Intro to Programming (Python)\\
    & 32B  & 4 & ECS 32A/36A  & Intro to Data Structures (Python)\\
    & 32C  & 4 & ECS 32B      & Impl of Data Structures (Unix/C)\\
    & 34*  & 4 & ECS 32C      & Software Dev. in Unix \& C++ \\
\hline
    & & & or: & \\
ECS & 36A  & 4 &                     & Programming and Problem Solving\\
    & 36B  & 4 & ECS 36A         & Software Dev. and OOP in C++\\
    & 36C  & 4 & ECS 20, 36B & Data Structs, Algs, and Programming\\
\hline
\end{tabular}\\
...
ECS & 117  & 4 & ECS 20,32B/36C & Alg. for Data Science\\
    ...
    & 122B & 4 & ECS 122A,34/36C& Algorithm Design \& Analysis\\
    & 127  & 4 & ECS 20,32A/36A & Cryptography \\
    & 130  & 4 & ECS 32A/36A & Scientific Computation \\
    & 132  & 4 & ECS 20,34/36B,  & Probability \& Stat Modeling \\
...
\hline
    & & &  Choose four of: & \\
EEC & 110A  & 4 & EEC 100, 111$\parallel$/140A$\parallel$ & Electronic Circuits I \\
...
\hline
ENG & 45     & 4 & CHE 2B/4A & Properties of Materials \\
\hline
\end{tabular}
\vskip 0.25cm
\noindent
...
PHY & 140B    & 4 &        & \\
EMS & 160     & 4 & ENG 45 & Thermo of Materials.  \\
...
\end{tabular}\\
\noindent
$\dagger$: At least three, including PHY 140B, recommended.  EMS 147 has extensive CHE prerequisites, but it may be used to satisfy one the required courses.\\
...
Course & & Units & Prereqs & Name \\
\hline
G$\to$EPS & 50   & 3 & & Physical Geology \\
          & 50L  & 2 & G$\to$EPS 50$\parallel$ & Physical Geology Laboratory\\
\hline
\hline
& & & Either: & \\
...
CHE & 4A$\dagger$ & 5 &            & Gen. Chem. for Phys. Sci. \\
    & 4B$\dagger$ & 5 & CHE 4A & Gen. Chem. for Phys. Sci. \\
G$\to$EPS & 60$\to$101          & 4$\to$3 & CHE 4B, G$\to$EPS 50+L & Earth Materials\\
\hline
\end{tabular}\\
...
G$\to$EPS & 101$\to$102\# & 3 & G$\to$EPS 50+L & Structural Geology \\
          & 162\#         & 3$\to$4 & & Geodynamics \\
          & 163\#         & 3 & G$\to$EPS 50    & Planetary Geology \& Geophysics \\
...
PHY       & 122A/B & 4 & & \\
          & 117    & 4 & & \\
          & 118    & 4 & & \\
EPS       & 101L   & 2 & EPS 101$\parallel$ & Earth Materials Lab\\
G$\to$EPS & 101L$\to$102L   & 2 & G$\to$EPS 50+L,101$\to$102$\parallel$ & Structural Geology Lab\\
\hline
\end{tabular}\\
\noindent
$^\#$: not offered every year, $\parallel$: concurrently, $\dagger$
alternative upper division coursework from PHY, GEL, EPS, or ATM can be
substituted, with consent of department, in case none of these courses
are available.\\[4pt]
\noindent
{\bf Electives:} Four additional upper division course offerings in ATM, EPS, GEL, or PHY of four or more units, or three units with consent of the department, or from the following list of pre-approved three-unit courses:  EPS 101,102,109,116,132,137,150B,161,162,163.\\[4pt]
\noindent
{\bf Total Units (minimum):} 108
(Tables \ref{tbl:prep}, \ref{tbl:depth-applied}, and \ref{tbl:geophysics} $\implies 52+24+9+11+12$)\\

%Theoretical minimum for electives is 12 units, but due to course
%scheduling, this is generally not possible to achieve, so the minimum
%units for this major will be capped at 108.
...
G$\to$EPS & 116N$\to$116   & 3 & G$\to$EPS 50       & Oceanography\\
    & 150A$\#$  & 4 & EPS 116,CHE 4C & Physical and Chemical Oceanography\\
    & 150B      & 3$\to$4 & G$\to$EPS 50       & Geological Oceanography\\
...
\hline
CHE & 4A$\dagger$ & 5 &        & Gen. Chem. for Phys. Sci.\\
    & 4B$\dagger$ & 5 & 4A & Gen. Chem. for Phys. Sci.\\
    & 4C$\dagger$ & 5 & 4B & Gen. Chem. for Phys. Sci.\\
G$\to$EPS & 50          & 3 & & Physical Geology \\
ATM & 60*         & 4 & & Intro. to Atmospheric Sci. \\
\hline
\end{tabular}\\
...
\hline
G$\to$EPS & 116N$\to$116     & 3 & G$\to$EPS 50      & Oceanography\\
    & 150A$\dagger$ & 4 & G$\to$EPS 116N$\to$116,   & Phys. \& Chem. Oceanography\\
    &          &   & CHE 2C/4C   & \\
\hline
    & & & Choose two of & \\
\hline
...
G$\to$EPS & 108       & 3 & G$\to$EPS 50 & Paleoclimatology\\
    & 109       & 3 & G$\to$EPS 50 & Earth History: Sediments \& Strata\\
    & 150B      & 3 & G$\to$EPS 50 & Geological Oceanography\\
\hline
\end{tabular}\\
\noindent
$\parallel$: concurrently, $\dagger$: students should consult the EPS
department course schedule to determine when EPS 150A will be offered,
and plan accordingly, including completing EPS 116 beforehand.
...
\hline
CHE & 4A$\dagger$ & 5 &        & Gen. Chem. for Phys. Sci.\\
CHE & 4B$\dagger$ & 5 & 4A & Gen. Chem. for Phys. Sci.\\
CHE & 4C$\dagger$ & 5 & 4B & Gen. Chem. for Phys. Sci.\\
\hline
\end{tabular}\\
\noindent
*: recommended, $\dagger$: CHE 2ABC can be substituted with consent of the department.\\
...
the AB, of which 32 units are in upper division coursework.  Note that the
...
Junior    & 40         & 45           & 80 \\ 
          & 104A       & 105A         & 110B \\ 
          & ATM 60     & 110A         & {\it G$\to$EPS 161} \\
          & (G$\to$EPS 50+L) &              & (9D) \\
\hline
Senior   & 112+L         & {\it 118}      & {\it G$\to$EPS 109}\\
         & 115A          & {\it G$\to$EPS 116N} & {\it G$\to$EPS 109L}\\
...
Junior    & 40         & 45             & 80 \\
          ...
          & (G$\to$EPS 50)   & 110A           & (9D) \\
\hline
Senior   & 112+L       & G$\to$EPS 116N       & G$\to$EPS 150A \\
         & 115A        & 118            & {\it G$\to$EPS 150B} \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\noindent
{\bf Example schedule:} In most cases, the PHY 9D and G$\to$EPS 50 are taken
before the junior year, but an example including these courses is

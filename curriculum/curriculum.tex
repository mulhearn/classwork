...
\captionof{table}{\label{tbl:current-transfers} An example schedule
  ...
  advanced elective.  Instructors have found it impossible to cover
  sufficient material in PHY 102 while remaining within the workload
  limits for a one-unit course.}

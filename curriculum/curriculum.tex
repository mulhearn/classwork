...
\captionof{table}{\label{tbl:current-honors} An example schedule for
  an undergraduate physics major that takes the 9H series and
  122A. Physics course numbers are shown with the number of units in
  parenthesis.  Math courses start with M.  Taking MAT 21A in fall is
  also common with instructor permission, with MAT 21D taken over the
  summer to catch up in time for 9HD.  Courses in italics are
...
\captionof{table}{\label{tbl:current-transfers}
    An example schedule for undergraduate physics major that

...
\node[above right] at (0,0) {9A-D, 9HA-HD, 40, 104A (MTH 21A-D, 22AB)};
\draw (0,2) -- ++(0,1) -- ++(10,0) -- ++(0,-1) -- ++(-10,0);
\node[above right] at (0,2) {80, 102, 105A, 110AB, 112, 115A};
\draw (0,4) -- ++(0,1) -- ++(10,0) -- ++(0,-1) -- ++(-10,0);
\node[above right] at (0,4) {105BL, 112L, 115BL, 116AB, 122AB};
\draw[->] (5,1) --(5,2);
\draw[->] (5,3) --(5,4);
\end{tikzpicture}

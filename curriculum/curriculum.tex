...
% top tier:
\node[right] at (0,6.5) {122AB 115B {\underline{116C}},{\underline{115C}}, Capstone Courses};
...
\captionof{table}{\label{tbl:impone} Implementation
  Year One Offerings}
\noindent
...
implemented: \captionof{table}{\label{tbl:impone} Implementation Year
  Two Offerings}
\noindent

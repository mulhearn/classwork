...
departments intentions in offering these alternative courses.
...
\captionof{table}{
  ...
  meet prerequisites.  The prerequisites for the math courses are set
  by the math department and are only reported here with

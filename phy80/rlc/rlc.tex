...
(a) & (b) & (c) \\
\end{tabular}
\caption{Circuit diagram from a (a) diode and equivalent circuits for (a) reverse bias and (b) forward bias.}
\label{fig:diodeeqv}
\end{center}
\end{figure}
...
\caption{ Diode $I$-$V$ curves in the basic operational model.  For a typical silicon diode $V_{\rm D} = 0.6~\rm V$.}
\label{fig:diodebasic}
\end{center}
\end{figure}
...
V_{\rm T} = \frac{kT}{e},
\end{displaymath}
which has the value $26~\rm mV$ at room temperature.

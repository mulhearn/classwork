...
the first nonzero digit ias a two.
...
&=& \sigma^2_x + \sigma^2_y\\
\end{eqnarray*}
In the exercises you will show that even if $\braket{x}$ and
$\braket{y}$ are non-zero, and for constants $A$ and $B$ and $C$, this
result generalizes to:
\begin{displaymath}
\sigma^2(Ax+By+C) = A^2\sigma^2_x + B^2\sigma^2_y
\end{displaymath}

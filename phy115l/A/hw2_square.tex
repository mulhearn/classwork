...
\section{Introduction and System of Units}
...
In our computer programs, we set $a=1$ and $E_0=1$, which is
equivalent to reporting lengths in units of $a$ and energy in units of
$E_0$.

In this assignment, we'll apply the same techiques to determine the
wave function for bound states of the finite square well.

...
for the nuclear strong force which binds the nucleus together.  A good reference for our approach is here: https://arxiv.org/pdf/0709.3525.
...
\end{cases}
$$
which accounts for the fraction of the total change $Ze$ enclosed in a sphere at or radius $r$.


\section{The Shell Model and Binding Energy}

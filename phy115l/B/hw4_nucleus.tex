...
a   &=& 0.5 ~ {\rm fm}\\
\end{eqnarray*}
Note that we will use different values of $r_0$ for protons and neutrons in some of the  exercises.
...
where
$$R/L = (r_0/L) A^{1/3} $$
and typical (dimensionless) parameter values are
\begin{eqnarray*}
V_0/\epsilon &=& 0.25 \\
r_0/L &=& 1.25 \\
a/L   &=& 0.5 \\
...
a/L   &=& 0.65 \\
\end{eqnarray*}
For $l=0$ (no centrifugal barrier) and no Coulomb term, the ground
state energy should be $-38.3~\rm MeV$ (this is the 1S orbital).  The next state with $l=0$ should be $-18.2~\rm MeV$ (this is the 2S orbital).\\[5pt]
...
Produce an energy level diagram, with neutrons on the left and protons on the right.  Draw a line at each energy level and label it with the orbital and occupancey (e.g. ``1P (6)'').  You plot should make it clear where the magic numbers 2,8,20,and 40 come from.  Isotopes with a number or protons or neutrons equal to a magic number are particularly stable.  

...
\plot Apply five iterations of your function \pyth{bisection(f,a,b)} to the range (0,2.5).  Do you approach the correct root?   \\

\plot  Starting from estimates a=0 and b=2.5, apply five iterations of your function \pyth{secant(f,a,b)}.  Do you approach the correct root? \\


\plot Starting from the value x=2.5, apply five iterations of your function \pyth{newton(f,fp,x)}.  Do you approach a root? \\
